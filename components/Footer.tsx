          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 bg-white/5 rounded-lg hover:bg-white/10 hover:text-white text-mc-textMuted transition-colors group"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 bg-white/5 rounded-lg hover:bg-white/10 hover:text-white text-mc-textMuted transition-colors"
              >
