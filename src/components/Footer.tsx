...
const Footer = () => {
  ...
  return (
    <footer className="bg-black/60 backdrop-blur-sm border-t border-white/10 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-2 space-y-4">
            ...
            <p className="text-sm text-mc-text-muted max-w-sm leading-relaxed">{t.footer.desc}</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-mc-text text-sm">
              ...
              <li>
                <Link to="/$lang/wiki" params={langParams} preload="intent" className="hover:text-mc-green-text transition-colors">
                  {t.hero.wiki}
                </Link>
              </li>
              <li>
                <Link to="/$lang/credits" params={langParams} preload="intent" className="hover:text-mc-green-text transition-colors">
                  {t.footer.credits}
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 bg-white/5 rounded-lg hover:bg-white/10 hover:text-white text-mc-text-muted transition-colors group"
              >
