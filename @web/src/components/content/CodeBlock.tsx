...
const codeTheme: PrismTheme = {
  ...
  styles: [
    ...
    // diff: + lines are the inserted tone above, - lines stand out in red
...
const CodeBlock = ({ code, language, ...props }: CodeBlockProps) => {
  ...
  const preClassName = "overflow-x-auto rounded-xl border border-zinc-700 bg-zinc-800 p-4 pt-10 shadow-lg font-mono";
