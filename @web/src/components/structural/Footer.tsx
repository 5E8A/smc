      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 grid grid-cols-1 gap-12 md:grid-cols-4">
          ...
          <div className="col-span-1 space-y-4 md:col-span-2">
            ...
            <p className="max-w-sm text-sm leading-relaxed text-mc-text-muted">&copy; 2026 {t.footer.copyright}</p>
            <p className="max-w-sm text-sm leading-relaxed text-mc-text-muted hover:text-white pointer-events-auto">
        ...
        <div className="border-t border-white/5 pt-8">
          <div className="flex flex-col items-start justify-center text-sm text-mc-text-muted md:flex-row md:items-center">
