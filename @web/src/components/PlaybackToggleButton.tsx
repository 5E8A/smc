...
export const PlaybackToggleButton = ({ playing, onToggle, className = "" }: PlaybackToggleButtonProps) => {
  ...
  return (
    <button
      ...
      className={`z-10 rounded-full bg-black/60 p-1.5 text-white backdrop-blur-sm transition-colors hover:bg-white hover:text-black focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white ${className}`}
    >
